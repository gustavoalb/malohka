class EstaticosController < ApplicationController
  ...
  def show
    ...
    redirect_to estaticos_path(@pagina.id)#respond_with(@pagina)respond_with(@pagina)respond_with(@pagina)
  end
  ...
  def create
    ...
    @pagina.save
    redirect_to estaticos_path(@pagina.id)#respond_with(@pagina)respond_with(@pagina)
  end
