class Componente < ActiveRecord::Base
  ...
  accepts_nested_attributes_for :periodos, :reject_if => lambda { |a| a[:qnt_horas].blank? }, :allow_destroy => true
  ...
  enum tipo_componente: {'Palestra'=> 1, 'Seminário'=>2, 'Minicurso'=> 3, 'Mesa redonda'=> 4, 'Mostra Técnica'=> 5, 'Atividade Cultural'=> 6, 'Apresentação'=> 7, 'Concurso'=> 8, 'Anúncio'=> 9}
