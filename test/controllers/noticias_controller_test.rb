...
class NoticiasControllerTest < ActionController::TestCase
  ...
  test "should create noticia" do
    assert_difference('Noticia.count') do
      post :create, noticia: { conteudo: @noticia.conteudo, destaque: @noticia.destaque, pauta: @noticia.pauta, publicado: @noticia.publicado, publicado_em: @noticia.publicado_em, titulo: @noticia.titulo }
    end
  ...
  test "should update noticia" do
    patch :update, id: @noticia, noticia: { conteudo: @noticia.conteudo, destaque: @noticia.destaque, pauta: @noticia.pauta, publicado: @noticia.publicado, publicado_em: @noticia.publicado_em, titulo: @noticia.titulo }
    assert_redirected_to noticia_path(assigns(:noticia))
  end
