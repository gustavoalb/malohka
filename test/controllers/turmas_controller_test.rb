...
class TurmasControllerTest < ActionController::TestCase
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post :create, turma: { codigo: @turma.codigo, curso_id: @turma.curso_id, nome: @turma.nome, turno: @turma.turno }
    end
  ...
  test "should update turma" do
    patch :update, id: @turma, turma: { codigo: @turma.codigo, curso_id: @turma.curso_id, nome: @turma.nome, turno: @turma.turno }
    assert_redirected_to turma_path(assigns(:turma))
  end
